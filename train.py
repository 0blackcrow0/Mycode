...
viz = Visdom(env='yolov5-hwc')
viz.line([0.], [0.], win='Loss', opts=dict(title='Lseg'))
viz.line([0.], [0.], win='Loss_par', opts=dict(title='Lpar'))
@ex.automain
def main(_run, _config, _log):
    ...
    for i_iter, sample_batched in enumerate(trainloader):
        ...
        if (i_iter + 1) % _config['print_interval'] == 0:
            ...
            viz.line([loss.item()], [i_iter + 1], win='loss', update='append')
            viz.line([align_loss.item()], [i_iter + 1], win='align_loss', update='append')
