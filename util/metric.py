...
class Metric(object):
    """
    Compute evaluation base+hun91+mutil_pro3
    ...
    Args:
        ...
        n_runs:
            number of test runs
    """
    def __init__(self, max_label=10, n_runs=None):
    ...
    def record(self, pred, target, labels=None, n_run=None):
        """
        Record the evaluation base+hun91+mutil_pro3 for each sample and each class label, including:
