...
names as the splits. Each folder has base+Scribble+Scribble+hun64+mutil_pro txt files
...
# set path
voc_dir = r'G:\hwc\1\few-shot\PANet-master\data\VOCdevkit2\VOC2012/'
seg_dir = os.path.join(voc_dir, 'SegmentationObjectAug')
...
# write the base+hun91+mutil_pro3 to file
for split in dic:
