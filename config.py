...
def cfg():
    ...
    if mode == 'train':
        ...
        notrain = False
        snapshot = r'G:\hwc\1\few-shot\PANet-master\runs\PANet_Final_VOC_align_sets_0_1way_1shot_[train]\3\snapshots\30000.pth'
        n_runs = 5
        n_steps = 1000
        batch_size = 1
        scribble_dilation = 0
    ...
    path = {
        ...
        'VOC':{'data_dir': './data/VOCdevkit_disease_pro/VOC2012/',
               'data_split': 'trainaug',},
